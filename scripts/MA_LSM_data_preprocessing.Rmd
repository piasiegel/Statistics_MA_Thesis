...
write_xlsx(df_acc_cond_summary, here("./RData/data_acc_cond.xlsx"))
```
...
write_xlsx(df_rt_cond_summary, here("./RData/data_rt_cond.xlsx"))
```
...
write_xlsx(df_acc_congr_summary, here("./RData/data_acc_congr.xlsx"))
```
...
write_xlsx(df_rt_congr_summary, here("./RData/data_rt_congr.xlsx"))
```