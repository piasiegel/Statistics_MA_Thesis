...
## Extract data frame "data_acc.xlsx"
write_xlsx(df_acc_summary, here("./RData/data_acc.xlsx"))
```
...
# Create dataframe for response time (condition; SVR-LSM)
```{r}
...
# Create dataframe for response time (condition; NiiStat)
```{r}
## remove incorrect trials from data frame
...
# Create dataframe for accuracy (congruency; SVR-LSM)
```{r}
## create new data frame with relevant variables 
...
# Create dataframe for accuracy (congruency; NiiStat)
```{r}
## create new data frame with relevant variables 
...
# Create dataframe for response time (congruency; SVR-LSM)
```{r}
...
# Create dataframe for response time (congruency; NiiStat)
```{r}
## remove incorrect trials from dataframe
