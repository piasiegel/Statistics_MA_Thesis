---
title: "MA_LSM_data_preprocessing_for_SVR-LSM-GUI"
author: "Siegel"
date: "2023-11-14"
...
## Extract data frame "NiiStat_acc.xlsx"
write_xlsx(df_acc_summary, here("./RData/NiiStat_acc.xlsx"))
```
...
## Extract data frame "NiiStat_acc_cond.xlsx"
write_xlsx(df_acc_cond_summary, here("./RData/NiiStat_acc_cond.xlsx"))
```
...
## Extract data frame "NiiStat_rt_cond.xlsx"
write_xlsx(df_rt_cond_summary, here("./RData/NiiStat_rt_cond.xlsx"))
```
...
## Extract data frame "NiiStat_acc_congr.xlsx"
write_xlsx(df_acc_congr_summary, here("./RData/NiiStat_acc_congr.xlsx"))
```
...
## Extract data frame "NiiStat_rt_congr.xlsx"
write_xlsx(df_acc_cond_summary, here("./RData/NiiStat_rt_congr.xlsx"))
```