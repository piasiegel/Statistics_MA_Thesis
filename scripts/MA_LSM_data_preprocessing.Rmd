...
## Extract data frame "acc.xlsx"
write_xlsx(df_acc_summary, here("./RData/acc.xlsx"))
```
...
## Extract data frame "acc_cond.xlsx"
write_xlsx(df_acc_cond_summary, here("./RData/acc_cond.xlsx"))
```
...
## Extract data frame "rt_cond.xlsx"
write_xlsx(df_rt_cond_summary, here("./RData/rt_cond.xlsx"))
```
...
## Extract data frame "acc_congr.xlsx"
write_xlsx(df_acc_congr_summary, here("./RData/acc_congr.xlsx"))
```
...
## Extract data frame "rt_congr.xlsx"
write_xlsx(df_rt_congr_summary, here("./RData/rt_congr.xlsx"))
```