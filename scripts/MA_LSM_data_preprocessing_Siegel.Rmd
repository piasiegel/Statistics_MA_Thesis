...
df_rt_WPM <- left_join(df_acc_WPM, df_rt_WPM, by = c("RegistryCode", "run"))
...
# Now use this df to filter rt df
df_rt_FPM <- left_join(df_acc_FPM, df_rt_FPM, by = c("RegistryCode", "run"))
...
# Now use this df to filter rt df
df_rt_incongr <- left_join(df_acc_incongr, df_rt_incongr, by = c("RegistryCode", "run"))
